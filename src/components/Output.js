...
class Output extends React.PureComponent {
  ...
  renderLetter(name) {
    switch (name) {
      ...
      case "Ethan":
        return "Ethan, my second dad, I don't know how many times you fucked my head with all of your wisdom and history stories when I got here. Literally the first week I learned more about American history and how things worked than I did in any class I took in college. You introduced a new way of thinking to me that I will definitely be in my mind for the rest of my life. Whether it'd be the Golden Circle or Hypothesis Driven testing, your mentorship and guidance for me was invaluable and I hope our Patagonia vests will meet again in the near future. 🇺🇸";
      case "Eric":
